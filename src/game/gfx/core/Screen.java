...
public class Screen {
	...
	public void render(int xOffs, int yOffs, int xo, int yo, int w, int h, int cols, int bits) {
		this.viewPort.draw(this.sprites, xOffs - this.xOffset, yOffs - this.yOffset, xo, yo, w, h, cols, bits);
	}
	
	public void render(int scale, int xOffs, int yOffs, int xo, int yo, int w, int h, int cols, int bits) {
		this.viewPort.draw(this.sprites, scale, xOffs - this.xOffset, yOffs - this.yOffset, xo, yo, w, h, cols, bits);
	}
	
	public void render(double angle, int xOffs, int yOffs, int xo, int yo, int w, int h, int cols, int bits) {
		this.viewPort.draw(angle, this.sprites, xOffs - this.xOffset, yOffs - this.yOffset, xo, yo, w, h, cols, bits);
	}
