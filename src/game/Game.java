...
public class Game extends Rasterizer implements Runnable {
	...
	public static final String TITLE = "Wisteria v0.3";
	...
	public void init() {
		...
		this.level.add(new Board("Testing dialogue system!", 300, 300));
	...
	public void render(int fps) {
		...
		this.level.getDialogueManager().render(this.screen);
		
		Font.drawPanel("Score: " + this.player.getScore() + " Health: " + this.player.getHealth(), this.screen, 10, 220, PaletteHelper.getColor(5, 555, 555, 555));
